...
namespace NuGet.Protocol.Tests
{
    public class RepositorySignatureResourceTests
    {
        ...
        public async Task RepositorySignatureResource_RepositorySignatureInfo()
        {
            ...
            var repositorySignatureInfo = RepositorySignatureInfoProvider.Instance.GetRepositorySignatureInfo(source);
            ...
            var certInfor = repositorySignatureInfo.RepositoryCertificateInfos.FirstOrDefault();
            VerifyCertInfo(certInfor);
        }
        ...
        public async Task RepositorySignatureResource_RepositorySignatureInfoConcurrency()
        {
            ...
            // Assert
            var repositorySignatureInfo1 = RepositorySignatureInfoProvider.Instance.GetRepositorySignatureInfo(source1);
            var repositorySignatureInfo2 = RepositorySignatureInfoProvider.Instance.GetRepositorySignatureInfo(source2);
            var repositorySignatureInfo3 = RepositorySignatureInfoProvider.Instance.GetRepositorySignatureInfo(source3);
